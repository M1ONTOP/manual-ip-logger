...
echo.
echo       [40;37m^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>^>[40;30m
echo       [40;37m     ^<^>[40;33m Press 1 to open IP Logs Database [40;37m~[40;33m Made by M1 [40;37m^<^>
echo       [40;37m^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<^<[40;30m
echo.[40;37m
set /p name=[40;30m [40;30m [40;30m [40;30m [40;30m [40;30m [40;36mPRESS 1 OR ENTER TARGET NAME TO START LOG:[40;31m 
echo.
if %name% == 1 goto open
